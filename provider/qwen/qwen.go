// Package qwen provides a Qwen CLI provider implementation.
package qwen
...
// Provider implements the provider.Provider interface for Qwen CLI.
type Provider struct {
	provider.BaseProvider
}

// New creates a new Qwen provider with the given configuration.
...
// Execute sends a request to Qwen CLI and returns a structured response.
